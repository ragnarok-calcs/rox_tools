...
EDITOR_GROUPS = [
    ...
    ('Element',      '🌀',  ['elemental_counter', 'element_enhance', 'bonus_dmg_element'], ['element_resist'],
        lambda o, d: max((o['elemental_counter'] + o['element_enhance']) / 100, 0.2) * (1 + o['bonus_dmg_element'] / 100),
